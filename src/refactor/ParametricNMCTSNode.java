...
public class ParametricNMCTSNode {
     ...
     * @throws Exception
     */
    public ParametricNMCTSNode(int player, GameState gameState, ParametricNMCTSNode parent, int nodeID, boolean exploreNonSampledActions) throws Exception {
        this.parent = parent;
        ...
        if (this.gameState.winner() != -1 || this.gameState.gameover()) // Terminal node
            ...
            type = 0;
            actionGenerator = new ParametricActionGenerator(this.gameState, player);
...
//            System.out.println("Back : " + actionGenerator.getBackUnits().size());
            ...
            type = 1;
            actionGenerator = new ParametricActionGenerator(this.gameState, 1 - player);
...
//        System.out.println(playerAction);
        ...
        if (oldChild == null) { // If no node with the same playerActionCode exists, create one.
            ...
            ParametricNMCTSNode newChild = new ParametricNMCTSNode(player, newGameState.clone(), this, nodeID, exploreNonSampledActions);
