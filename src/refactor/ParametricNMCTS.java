...
public class ParametricNMCTS extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public ParametricNMCTS(UnitTypeTable unitTypeTable, float allowProbability) {
        this(unitTypeTable);
    ...
    public void startNewComputation(int player, GameState gameState) throws Exception {
        ...
        tree = new ParametricNMCTSNode(player, gameState, null, currentIteration++, exploreNonSampledActions);
